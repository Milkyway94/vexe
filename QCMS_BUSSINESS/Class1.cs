...
namespace QCMS_BUSSINESS
{
    ...
    {
        public  static dynamic SqlQuery(string procedureName, string parameters)
        {
            using (vexedtEntities context = new vexedtEntities())
            {
                string sql = "EXEC " + procedureName + " " + parameters;
                var rs = DynamicSqlQuery(context.Database, sql);
        ...
        public static int SqlExecute(string sql)
        {
            using (vexedtEntities context = new vexedtEntities())
            {
                int rs = context.Database.ExecuteSqlCommand(sql);
                return rs;
            }
        }
