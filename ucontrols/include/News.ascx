            ...
            <div class="fw">
                <div class="fw news">
                    ...
                    <div class="tindocnhieu fw">
                        ...
                        <div class="col-md-4 col-xs-12 sidebar lst-tdn <%Response.Write(display); %>">
                ...
                <div class="sidebar">
                    <div class="w100">
                        <div class="top-sidebar">
                            <h3><span class="icon i5"></span><a href="#"><% Response.Write(Value.GetValue(Session["vlang"].ToString(), "lbHotNews ")); %></a></h3>
                            ...
                            <h3><span class="icon i5"></span><a href="#"><% Response.Write(Value.GetValue(Session["vlang"].ToString(), "lbNewArival ")); %></a></h3>
                            <div class="td-sidebar-left">
                                <ul>
