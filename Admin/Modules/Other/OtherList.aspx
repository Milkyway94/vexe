<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OtherList.aspx.cs" Inherits="Admin_Modules_Other_OtherList" %>
...
<head id="Head1" runat="server">
    ...
    {	
        ...
        b.attachURL("OtherView.aspx?id="+id);
    }
</script>
</head>
    ...
    <div id="winVP" style="position: relative; height: 92%;">
        ...
        <asp:GridView ID="gvData" runat="server" Width="100%" CellPadding="3" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast"
            ...
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Tiêu đề" SortExpression="Other_Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hplName" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Mã nhận biết">
                    <ItemTemplate>
                        <asp:HyperLink ID="hplMod" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Option">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:ImageButton ID="imgDel" CommandName="del" runat="server" CommandArgument='<%# Eval("Other_ID") %>' ImageUrl="../../Themes/delete.gif" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
