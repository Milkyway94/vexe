<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoleList.aspx.cs" Inherits="DepartmentList" %>
    ...
    <div id="winVP" style="position: relative; height: 92%;">
        <table id="toolbar" cellspacing="0" style="display:block" border="0">
		    <tr>
			    <td> 
				    <table cellspacing="0">
					    <tr>
					        <td class="toolBarButton"><img alt="" src="<%=tp%>add.gif" align="absmiddle" /> <asp:HyperLink ID="hplAddDepart" runat="server">Thêm Vai trò</asp:HyperLink></td>	
						    <td><img src="<%=tp%>line.gif" align="absmiddle" alt="" /></td>
						    
						    <td class="toolBarButton"><img alt="" src="<%=tp%>add.gif" align="absmiddle" /> <asp:HyperLink ID="hplAdd" runat="server">Thêm user</asp:HyperLink></td>	
						    <td><img src="<%=tp%>line.gif" align="absmiddle" alt="" /></td>
        ...
        <asp:GridView ID="gvData" runat="server" Width="100%" CellPadding="3" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast"
            ...
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Vai trò" SortExpression="Role_Name">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Tình trạng">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="imgUse" CommandName="isUse" runat="server" CommandArgument='<%# Eval("Role_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Option">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:ImageButton ID="imgDel" CommandName="del" runat="server" CommandArgument='<%# Eval("Role_ID") %>' ImageUrl="../../Themes/delete.gif" />
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
                ...
                <HeaderStyle BackColor="#E1F0F5" Font-Bold="True" HorizontalAlign="Left" />
