<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Content_Default" %>
<asp:Content ID="Content" ContentPlaceHolderID="Main" Runat="Server">
    ...
    <script type="text/javascript">
      ...
      function doOnLoad() {            
          ...
          dhxLayout.cells("b").attachURL("UserList.aspx");
      }     
      doOnLoad();       
    </script>
</asp:Content>