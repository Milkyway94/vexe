...
public partial class Admin_Modules_Content_Default : DefaultAdmin
{
    ...
    //    str.Append("var tree = new ADCTree('ADC Manager', '" + tp + "Tree/config.gif');");
    ...
    //    DataSet ds = UpdateData.UpdateBySql("SELECT * FROM tbl_Mod WHERE lang=" + Session["lang"] + " AND Mod_Level=1 ORDER BY Mod_Pos");
    ...
    //        if (!isUse)
    //        {
    //            sLocked = "&nbsp;<img border=0 src='" + tp + "Icons/security.gif'>";
    //        }
    //        str.Append("var Mod1" + L1 + " = new ADCTreeItem(\"" + CatName + sLocked + "\", 1, " + L1 + ",'" + tp + "Tree/folder.gif', false);");
    //        str.Append("Type.add( Mod1" + L1 + ");");
    //    }
    //    //====================================================
    //    DataSet dsSub = UpdateData.UpdateBySql("SELECT * FROM tbl_Mod WHERE lang=" + Session["lang"] + " AND Mod_Level=2 ORDER BY Mod_Pos");
    ...
    //    }
    //    //====================================================
    //    DataSet dsSub3 = UpdateData.UpdateBySql("SELECT * FROM tbl_Mod WHERE lang=" + Session["lang"] + " AND Mod_Level=3 ORDER BY Mod_Pos");
    ...
    //    }//====================================================
    //    DataSet dsSub4 = UpdateData.UpdateBySql("SELECT * FROM tbl_Mod WHERE lang=" + Session["lang"] + " AND Mod_Level=4 ORDER BY Mod_Pos");
    ...
    //    }
    //    //====================================================
    //    //str.Append("var Type = new ADCTreeItem(\"<b>Các định dạng</b>\", 5, 0,'" + tp + "tree/Langroot.gif', false);");
    //    //str.Append("tree.add(Type);");
    //    //DataSet dsModtype = UpdateData.UpdateBySql("SELECT * FROM tbl_Modtype ORDER BY Modtype_Pos");
    //    //DataRowCollection rowsType = dsModtype.Tables[0].Rows;
    //    //for (int i = 0; i < rowsType.Count; i++)
    //    //{
    //    //    string CatID = rowsType[i]["Modtype_ID"].ToString();
    //    //    string CatName = rowsType[i]["Modtype_Name"].ToString();
    //    //    str.Append("var ModGroup" + CatID + " = new ADCTreeItem(\"" + CatName + "\", 6, " + CatID + ",'" + tp + "Tree/used.gif', false);");
    //    //    str.Append("Type.add( ModGroup" + CatID + ");");
    //    //}
    //    //====================================================
