...
public partial class Mod_Tree : DefaultAdmin
{
    ...
    public void CreateTree()
    {
        ...
        DataSet ds = UpdateData.UpdateBySql("SELECT Mod_ID,Mod_Name,Mod_Status FROM tbl_Mod WHERE lang=" + Session["lang"] + " AND Mod_Level=1 ORDER BY Mod_Pos");
        ...
        str.Append("tree.add(Type);");
        DataSet dsModtype = UpdateData.UpdateBySql("SELECT Modtype_ID,Modtype_Name FROM tbl_Modtype ORDER BY Modtype_Pos");
