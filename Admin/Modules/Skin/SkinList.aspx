<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SkinList.aspx.cs" Inherits="SkinList" %>
    ...
    <div id="winVP" style="position: relative; height: 92%;">
        ...
        <asp:GridView ID="gvData" runat="server" Width="100%" CellPadding="3" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast"
            ...
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Tiêu đề" SortExpression="Skin_Name">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Module">
                    <ItemTemplate>
                        <asp:HyperLink ID="hplModule" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tình trạng">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="imgUse" CommandName="isUse" runat="server" CommandArgument='<%# Eval("Skin_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Option">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:ImageButton ID="imgDel" CommandName="del" runat="server" CommandArgument='<%# Eval("Skin_ID") %>' ImageUrl="../../Themes/delete.gif" />
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
