            ...
            <table id="toolbar" cellspacing="0" style="display: block" border="0">
                <tr>
                    <td>
                        <table cellspacing="0">
                            <tr>
                                <td class="toolBarButton"><i class="fa fa-plus"></i>
                                    <asp:HyperLink ID="hplAdd" runat="server">Thêm mới</asp:HyperLink></td>
                                <td>
                                    <img src="<%=tp%>line.gif" align="absmiddle" /></td>
                                <td class="toolBarButton"><i class="fa fa-exclamation-triangle"></i>
                                    <asp:HyperLink ID="hplHot" runat="server">Ưu tiên</asp:HyperLink></td>
                            ...
                            <td class="toolBarButton"><asp:HyperLink ID="hplShare" runat="server">Share</asp:HyperLink></td>	--%>
                                ...
                                <td>
                                    <img src="<%=tp%>line.gif" align="absmiddle" /></td>
                                <td>
                                    <input type="text" name="txtFind" id="txtFind" value="" runat="server" style="width: 200px;"></td>
