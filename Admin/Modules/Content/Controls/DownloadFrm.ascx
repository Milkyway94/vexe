<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DownloadFrm.ascx.cs" Inherits="Admin_Modules_Content_Controls_WeblinkFrm" %>
...
<table class="controlbox" width="100%" cellpadding="2">	
    <tr> 		                        			
		<td style="width:120px;">Tên sách:</td><td><asp:textbox id="txtName" Width="400" runat="server"></asp:textbox></td>
    </tr>	
	<tr>
		<td>Đề mục:</td><td><asp:DropDownList ID="ddlModID" runat="server"></asp:DropDownList></td>						
	</tr>	
	<tr> 		                        			
		<td>File sách:</td><td><asp:textbox id="txtImg" ClientIDMode="Static" Width="300" runat="server"></asp:textbox>
	...
	<tr>
	    <td>Vị trí:</td><td><asp:textbox id="txtPos" Width="100" runat="server"></asp:textbox>
