<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoctypeList.aspx.cs" Inherits="DoctypeList" %>
    ...
    <div id="winVP" style="position: relative; height: 92%;">
        ...
        <asp:GridView ID="gvData" runat="server" Width="100%" CellPadding="3" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast"
            ...
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Tên loại tài liệu" SortExpression="DocsType_Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hplName" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="DocsType_Description" HtmlEncode="False" HeaderText="Mô tả" SortExpression="DocsType_Description"></asp:BoundField>   
                <asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tình trạng">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="imgUse" CommandName="isUse" runat="server" CommandArgument='<%# Eval("DocsType_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Option">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:ImageButton ID="imgDel" CommandName="del" runat="server" CommandArgument='<%# Eval("DocsType_ID") %>' ImageUrl="../../Themes/delete.gif" />
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
