...
public partial class Config_Default : DefaultAdmin
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            hplAdd.NavigateUrl = "javascript:$('#updateframe').prop('src','"+url+ "'); $('#add-modal').modal();";
        }
    }
    ...
    protected void gvData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.DataItemIndex >= 0)
        {
            ...
            imgEdit.Attributes.Add("onclick", "javascript:$('#updateframe').prop('src','" + url + "'); $('#add-modal').modal();");
            //============================================
