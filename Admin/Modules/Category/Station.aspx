<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMasterPage.master" CodeFile="Station.aspx.cs" Inherits="Admin_Modules_Category_Station" %>

<asp:Content ContentPlaceHolderID="main" runat="server">
    <div class="box box-primary box-solid" ng-controller="BenXeController">
        <div class="box-header with-border">
            <h3 class="text-center"><b>QUẢN LÝ BẾN XE</b></h3>
        </div>
        <div class="box-body" >
