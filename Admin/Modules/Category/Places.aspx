<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/AdminMasterPage.master" CodeFile="Places.aspx.cs" Inherits="Admin_Modules_Category_Places" %>

<asp:Content ContentPlaceHolderID="main" runat="server">
    <div class="box box-primary box-solid" ng-controller="ChuyenXeController">
        <div class="box-header with-border">
            <h3 class="text-center"><b>QUẢN LÝ ĐIỂM ĐỖ/BẾN XE</b></h3>
        </div>
        <div class="box-body">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" ng-model="Huyen.MaTinh">
                                    <option class="select2" ng-repeat="item in Tinhs" ng-selected="item.MaTinh==Huyen.MaTinh" value="{{item.MaTinh}}">{{item.TenTinh}}</option>
                                </select>
                            </div>
                        </div>
