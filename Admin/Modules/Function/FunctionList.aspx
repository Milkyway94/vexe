    ...
    <div id="winVP" style="position: relative; height: 92%;">
        ...
        <asp:GridView ID="gvData" runat="server" Width="100%" CellPadding="3" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast"
            ...
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Tiêu đề" SortExpression="ModAdmin_Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hplName" runat="server"></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ModAdmin_Path" HtmlEncode="False" HeaderText="URL" SortExpression="ModAdmin_Path"></asp:BoundField>   
                <asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Tình trạng">
                    ...
                    <ItemTemplate>
                        <asp:ImageButton ID="imgUse" CommandName="isUse" runat="server" CommandArgument='<%# Eval("ModAdmin_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Option">
                    ...
                    <ItemTemplate>
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <asp:ImageButton ID="imgDel" CommandName="del" runat="server" CommandArgument='<%# Eval("ModAdmin_ID") %>' ImageUrl="../../Themes/delete.gif" />
                    </ItemTemplate>
                </asp:TemplateField>
                </Columns>
